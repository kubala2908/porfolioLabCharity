...
<form:form method="POST" action="/donation/form" modelAttribute="donation">
          ...
          <div data-step="1" class="active">
            ...
            <form:checkboxes path="categoryList" items="${categories}" itemLabel="name" cssClass="form-group form-group--checkbox" class="checkbox" />
...
<%--                <input type="number" name="bags" step="1" min="1" />--%>
          ...
          <div data-step="3">
            ...
            <form:radiobuttons items="${institutions}" path="institution" itemLabel="name"/>
<%--            <div class="form-group form-group--checkbox">--%>
<%--              <label>--%>
...
<%--                    <textarea name="more_info" rows="5"></textarea>--%>
            ...
            <div class="form-group form-group--buttons">
              <button type="button" class="btn prev-step">Wstecz</button>
              <button type="button" class="btn next-step" id="btn5">Dalej</button>
            </div>
          </div>
              ...
              <div class="form-section">
                ...
                <ul>
                  <li>
                    ...
                    <span class="summary--text" id="summaryBags"> 4 worki ubrań w dobrym stanie dla dzieci </span>
                  </li>
